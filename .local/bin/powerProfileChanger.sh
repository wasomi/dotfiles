...
# /_/____/ /_  ____ _____  ____ ___/_/_____        _____/ /_        
#  / ___/ __ \/ __ `/ __ \/ __ `/ _ \/ ___/       / ___/ __ \       
# / /__/ / / / /_/ / / / / /_/ /  __/ /     _    (__  ) / / /       
# \___/_/ /_/\__,_/_/ /_/\__, /\___/_/     (_)  /____/_/ /_/        
#                       /____/                                                               
# 
# credits: ai bot
# edited by: wasomi
...
choice=$(printf "Performance\nBalanced\nPower Saver" | rofi -dmenu -p "[$CURRENT_PROFILE] Select Power Profile" -config ~/.dotfiles/.config/rofi/styles/powerProfileChanger.rasi)
