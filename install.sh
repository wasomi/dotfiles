...
if [[ $install_gaming =~ ^[Yy]$ ]]; then
    ...
    paru -S --needed --noconfirm mangojuice-bin protonplus
...
echo ""
echo -e "${BLUE}[*]${NC} P.S."
echo -e "${BLUE}[*]${NC} If you don't have a desktop display manager, you can start Hyprland with: h"
echo -e "${BLUE}[*]${NC} Update keyboard, monitor names and configurations in ~/.dotfiles/hypr/conf/env.conf and ~/.dotfiles/hypr/conf/monitors.conf"
echo -e "${BLUE}[*]${NC} Change wallpaper using: Super + W or Super + R"
echo ""
